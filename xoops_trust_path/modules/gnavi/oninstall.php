...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return gnavi_oninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'gnavi_oninstall_base' ) ) {

function gnavi_oninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleInstall.' . ucfirst($mydirname) . '.Success' , 'gnavi_message_append_oninstall' ) ;
		$ret = array() ;
	} else {
...
function gnavi_message_append_oninstall( &$module_obj , &$log )
{
